            ...
            <form onSubmit={handleSubmit} className={s.formContainer}>
                ...
                <div className={s.section}>
                    ...
                    <div className={s.sectionContent}>
                        <div>
                            <label className={s.label}>Proeprty Title</label>
                            <input type='text' name='title' value={formData.title}
                            onChange={handleInputChange} placeholder='e.g. Luxury 3BHK apartment in downtown' className={s.input} required/>
                        </div>
                        <div>
                            <label className={s.label}>Detailed Description</label>
                            <textarea name='description' value={formData.description} onChange={handleInputChange} placeholder='Describe the property highlights...' className={s.textarea} required/>
                        </div>
                    </div>
                </div>
                ...
                <div className={s.section}>
                    ...
                    <div className={s.amenitiesGrid}>
                        {commonAmenities.map((amenity)=>(
                            <label key={amenity} 
                                className={s.amenityLabel(formData.amenities.includes(amenity))}
                            >
