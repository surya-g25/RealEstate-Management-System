    ...
    <div className={s.outerContainer}>
        <div className={s.innerContainer}>
            <div className={s.header}>
                <h1 className={s.heading}>List Your Properties</h1>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
                    ...
                    <div className={s.contentGroupLarge}>
                        <div>
                            ...
                            <input type='text' name='title' value={formData.title} 
                                onChange={handleInputChange} className={s.input} placeholder='e.g. Luxury 3BHK apartment in Downtown' required
                            />
                        </div>
                        <div>
                            <label className={s.label}>Detailed Description</label>
                            <textarea name="description" value={formData.description} onChange={handleInputChange} placeholder='Describe the property highlights...' className={`${s.input} ${s.textarea}`} required 
                            />
                        </div>
                    </div>
                </div>
                <div className={s.twoColumnGrid}>
                    ...
                    <div>
                        ...
                        <div className={s.contentGroupSmall}>
                            <div>
                                <label className={s.labelSmallMargin}>Price (in Rs.)</label>
                            ...
                            <div className={s.gridTwoCol}>
                                <div>
                                    ...
                                    <input type='text' name='city' value={formData.city} onChange={handleInputChange} placeholder='e.g. Orai' className={s.input} required/>
                                </div>

                                <div>
                                    <label className={s.labelSmallMargin}>Pincode</label>
                                    <input type='text' name='pincode' value={formData.pincode} onChange={handleInputChange} placeholder='e.g. 285001' className={s.input} required/>
                                </div>
                            </div>
                            <div>
                                <label className={s.labelSmallMargin}>Specific Area</label>
                                <input type='text' name='area' value={formData.area} onChange={handleInputChange} placeholder='e.g. Tulsi nagar' className={s.input} required/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        {commonAmenities.map((amenity)=>(
                            ...
                            >
                                ...
                                <span className={`${s.amenityTextBase} 
                                    ${
                                        formData.amenities.includes(amenity) ? s.amenityTextActive
                ...
                <div className={s.footerButtons}>
                    <button type='button' onClick={()=>navigate("/dashboard")} className={s.cancelButton}>
                        Cancel
                    </button>
