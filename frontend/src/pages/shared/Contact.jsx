                    ...
                    {success? (
                        ...
                        <form onSubmit={handleSubmit} className={s.form}>
                            ...
                            <div className={s.inputGroup}>
                                ...
                                onChange={handleChange} placeholder='+1 234 567 890' className={s.input}/>
                            </div>
                            <div className={s.inputGroup}>
                                    <label className={s.label}>
                                    ...
                                    onChange={handleChange} placeholder='Tell us how we can help...' rows='5' className={`${s.input} ${s.textarea}`}/> 
                            </div>
